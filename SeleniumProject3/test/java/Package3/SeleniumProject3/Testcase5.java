...
public class Testcase5 extends Screenshot_ITestListerner
{
	@Test
	 public void login_to_search()
	 {
		...
		driver.switchTo().window(cid1);
	     ...
	     Amazon_AddressSelect_Page a5 = new Amazon_AddressSelect_Page(driver);
	     a5.proceed_to_buy();
	     a5.select_address();
	     
	     WebElement addressbutton = driver.findElement(By.xpath("(//span[@class='a-button-inner'])[10]"));
	     Assert.assertEquals(addressbutton.isDisplayed(),true, "failed");
	 }
}
